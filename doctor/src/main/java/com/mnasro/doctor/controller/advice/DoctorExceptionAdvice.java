package com.mnasro.doctor.controller.advice;
...
import com.mnasro.doctor.exception.WebserviceValidationException;

@RestControllerAdvice
public class DoctorExceptionAdvice {

	private static final Logger LOG = LoggerFactory.getLogger(DoctorExceptionAdvice.class);
